<template>
  <div class="relative" v-if="isSearchable">
    ...
    <DebouncedInput :debounce="50" v-model="searchFilter[params.search]" class="h-8 w-[250px] pl-8 pr-8" :placeholder="messages.searchPlaceholder" />
...
const { searchFilter, isSearchable, params } = injectContext()
</script>
