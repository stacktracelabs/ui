...
export type DataTablePaginationLastProps = PrimitiveProps

export interface DataTablePaginationLastSlotProps {
  href: string | null
  disabled: boolean
...
const props = withDefaults(defineProps<DataTablePaginationLastProps>(), {
  asChild: false,
})

defineSlots<{
  default?: (props: DataTablePaginationLastSlotProps) => unknown
}>()
...
const href = computed(() => pagination.value?.lastPageUrl ?? null)
