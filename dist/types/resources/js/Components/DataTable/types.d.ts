...
export type DataTableTextStyleProperty = 'fontWeight' | 'fontFamily' | 'whitespace' | 'fontVariantNumeric' | 'textDecorationLine' | 'verticalAlign' | 'textAlign' | 'fontStyle' | 'color';
...
export type DataTableAction<EventName extends string = string> = DataTableEventAction<EventName> | DataTableLinkAction | DataTableExecutableAction;
...
export interface DataTableResourceActionsValue<ResourceKey extends DataTableResourceKey = DataTableResourceKey, ResourceValue = object, EventName extends string = string> {
...
export interface DataTableRowValue<ResourceKey extends DataTableResourceKey = DataTableResourceKey, ResourceValue = object, EventName extends string = string> {
    key: ResourceKey;
...
export interface DataTableValue<ResourceValue = object, ResourceKey extends DataTableResourceKey = DataTableResourceKey, EventName extends string = string> {
...
export interface DataTableEventPayload<ResourceKey extends DataTableResourceKey = DataTableResourceKey, EventName extends string = string> {
    name: EventName;
